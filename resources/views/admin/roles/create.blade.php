                        ...
                        <div class="card mb-5 mb-xl-8" style="user-select: auto;">
                            ...
                            <div class="card-body pt-3" style="user-select: auto;">
                                ...
                                <div class="modal-body">
                                    ...
                                    <!--end::Label-->
                                    <div class="row">
                                        <x-cento-dash-input type="text" name="name" label="Role Name" placeholder="Role Name" :message="$errors->first('name')"/>
                                        ...
                                        @foreach ($permissions as $permission)
                                            <x-cento-dash-input  type="checkbox" name="permission_checkbox[]" :label="$permission['name']" :value="$permission['id']" :message="$errors->first('permission_checkbox')"/>
                                        @endforeach
                                    </div>
                                </div>
